...
@onready var milestone : MilestoneStardust = HandlerConsciounessCore.ref.stardust_milestone
...
func _update_progress() -> void:
	...
	label.text = "%s / %s stardust" %[milestone.stardust_progress, milestone.stardust_goal] 
